...
public class Parameters {
    ...
    public static final float LAND_PERCENT_MIN = 0.4f;
    public static final float LAND_PERCENT_MAX = 0.45f;
    public static final int LAND_BORDER = (int) (0.05 * MAP_WIDTH);
    public static final int OBLIGATORY_LAND_BORDER = (LAND_BORDER + 1) / 2;
